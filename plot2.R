...
#  of global active power over the course of three days
#  
########################################################################
...
#Actual plotting
plot(powcns$Date, powcns$Global_active_power, type="n", xlab="", ylab="Global Active Power (kilowatts)")
lines(powcns$Date, powcns$Global_active_power)
